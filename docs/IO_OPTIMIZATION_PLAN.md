...
**Status: PLAN ONLY — written 2026-07-12, not yet executed.**
All deletion steps are gated on explicit owner approval (this project never
auto-deletes; see `recover.orphans`' pending_delete design and DECISIONS.md norms).
