# Pipeline Re-Architecture — Implementation Plan (Design Detail, archived)

> **狀態**:歷史設計記錄 —— 內容原屬 `docs/REARCHITECTURE_IMPLEMENTATION_PLAN.md` §1-7/§9-13,
> P0–P5 已全部完成落地(2026-07-19 文件瘦身時搬出),文件本身唔再更新。
> **想睇現行 milestone 狀態?** 見 `docs/REARCHITECTURE_IMPLEMENTATION_PLAN.md`
> (TL;DR + §8 Milestones,CLAUDE.md 引用嘅權威來源)。
> 呢份文件保留原本嘅 §編號(1、2、3…9、10…),同上游文件互相引用時對得上。
...
> `docs/archive/JOURNAL_FIRST_PLAN.md`(草擬,等 owner 拍板),包含 journal 格式、
